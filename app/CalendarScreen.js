  ...
  return (
    ...
    <View style={styles.container}>
        ...
        <View style={styles.overlay}>
          ...
          <Text style={[(styles.calendarText), { zIndex: 2 }]}>Calendar</Text>
          </View>
    ...
    <View style={[styles.navigationBar, {zIndex: 3}]}>
          <View style={styles.icons}>
            ...
            <Pressable onPress={navigateToCalendar}><Image style={styles.icon} source={require("../assets/OnCalendarIcon.png")} /></Pressable>
